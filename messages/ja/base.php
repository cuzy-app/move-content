...
return array (
  ...
  'Move content and users from one space to another' => 'コンテンツとユーザーをあるスペースから別のスペースに移動する',
  'Move content from one user to another' => 'あるユーザーから別のユーザーへコンテンツを移動する',
  'Move group users' => 'グループユーザーを移動する',
  'Move user profile content' => 'ユーザー プロファイル コンテンツを移動する',
  'Move users also' => 'ユーザーも移動する',
  'Move users from one group to another' => 'ユーザーをあるグループから別のグループに移動する',
